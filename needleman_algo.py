...
# -*- coding: utf-8 -*-
"""
Created on Sun Apr 22 11:24:57 2018
...
def check(seq1, seq2):
    seq1_align, seq2_align = global_algo(seq1, seq2)
    print("The global alignment of seq1 is ", seq1_align)
    print("The global alignment of seq2 is ", seq2_align)
    print()
...
def read_input(filename):
    ...
    s1_align, s2_align = global_algo(pandemic_influenza, M1_gene)
